...
traffic_model = model.train_model()


pred_vehicles = model.predict_traffic(traffic_model, 18, 0, 1)


new_time, traffic, reward = adjust_signal(pred_vehicles, 18)
print(f"ML Predicted Traffic: {traffic} | Adjusted Signal: {new_time}s")